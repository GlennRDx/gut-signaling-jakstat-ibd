...
for(i in seq_along(rds_files)) {
  ...
  dataset_info <- parse_dataset_info(dataset_names[i])
  ...
  umap_filename <- paste0(dataset_names[i], "_umap_features.pdf")
  ...
  # Save with new naming convention
  dotplot_filename <- paste0(dataset_names[i], "_dotplot.pdf")
  ggsave(dotplot_filename, plot = p, width = 16, height = 12, units = "in", dpi = 300)
